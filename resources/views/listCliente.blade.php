        ...
        <div class="container mt-5">
            ...
            margin-top: 130px;">
                <div class="card-header text-white" style="text-align: center;">
                    <h6 class="m-0">Clientes Cadastrados</h6>
                </div>
                <div class="card-body">
                    <table id="table_clientes" class="table table-hover" style="color: white;">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-unstyled btn-icon" type="button" onclick="window.location.href='/cliente/edit/{{$cliente->id}}'">
