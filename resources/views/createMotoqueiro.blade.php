...
<body>
    <form action="/motoqueiro" method="POST">
        @csrf
        <div class="mb-3">
      ...
      margin-top: 130px;">
          <div class="card-head" style="margin: auto;">
              <div class="textCadMoto" style="margin: auto;color: white;">
                  <p class="text-start" id="logintxt"><h6>Cadastro Motociclistas</h6></p>
              </div>
          </div>
          <div class="card-body">
              <form action="/motoqueiro" method="POST">
                @csrf
                  <div class="col-md-6" style="margin: auto;">
                    ...
                    <div class="col-md-6" style="margin: auto;">
                      ...
                      <input type="text" id="telefoneMoto" class="form-control" name="telefone">
                    </div>
                    <div class="col-md-6" style="margin: auto;">
