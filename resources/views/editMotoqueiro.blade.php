...
<body>
    <form action="/motoqueiro/update/{{$motoqueiro->id}}" method="POST">
        @csrf
        @method('PUT')
        <div class="mb-3">
            <label for="formGroupExampleInput" class="form-label">Nome</label>
            <input type="text" class="form-control" name="nome" placeholder="Nome..." value="{{$motoqueiro['nome']}}">
        </div>
        <div class="mb-3">
            <label for="formGroupExampleInput" class="form-label">Telefone</label>
            <input type="text" class="form-control" name="telefone" placeholder="Telefone..." value="{{$motoqueiro['telefone']}}">
        </div>
        <div class="mb-3">
            <label for="formGroupExampleInput2" class="form-label">Senha</label>
            <input type="text" class="form-control" name="senha" placeholder="Senha..." value="{{$motoqueiro['senha']}}">
        </div>
    ...
    <body>
      ...
      margin-top: 130px;">
          <div class="card-head" style="margin: auto;">
              <div class="textCadMoto" style="margin: auto;color: white;">
                  <p class="text-start" id="logintxt"><h6>Atualizar Motociclistas</h6></p>
              </div>
          </div>
          <div class="card-body">
            <form action="/motoqueiro/update/{{$motoqueiro->id}}" method="POST">
                ...
                @method('PUT')
                  <div class="col-md-6" style="margin: auto;">
                      <label for="inputNameMotociclista" class="form-label" style="color: white;display: flex;justify-content: center;">Nome:</label>
                      <input type="text" class="form-control" id="inputUser" maxlength="100" name="nome" value="{{$motoqueiro->nome}}">
                    </div>
                    <div class="col-md-6" style="margin: auto;">
                      <label for="inputTelefoneMoto" class="form-label" style="color: white;display: flex;justify-content: center;">Telefone:</label>
                      <input type="text" id="telefoneMoto" class="form-control" name="telefone" value="{{$motoqueiro->telefone}}">
                    </div>
                    <div class="col-md-6" style="margin: auto;">
                      <label for="inputSenhaMoto" class="form-label" style="color: white;display: flex;justify-content: center;">Senha:</label>
                      <input type="password" class="form-control" id="inputSenha" maxlength="100" name="senha" value="{{$motoqueiro->senha}}">
                    </div>
      ...
      <script>
        ...
        $('#telefoneMoto').mask('(00) 00000-0000'); // Aplica a máscara ao campo de telefone
        });
      </script>
    </body>
</html>