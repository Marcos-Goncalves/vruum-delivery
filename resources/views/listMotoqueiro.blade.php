        ...
        <div class="container mt-5">
            ...
            margin-top: 130px;">
                <div class="card-header text-white" style="text-align: center;">
                    <h6 class="m-0">Motociclistas Cadastrados</h6>
                </div>
                <div class="card-body">
                    <table id="table_motociclistas" class="table table-hover" style="color: white;">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                        ...
                        <tbody>
                            @foreach ($motoqueiros as $motoqueiro)
                            <tr>
                                <th scope="row">{{$motoqueiro->id}}</th>
                                <td>{{$motoqueiro->nome}}</td>
                                <td>{{$motoqueiro->telefone}}</td>
                                <td><button class="btn btn-unstyled btn-icon" type="button" onclick="window.location.href='/motoqueiro/edit/{{$motoqueiro->id}}'">
