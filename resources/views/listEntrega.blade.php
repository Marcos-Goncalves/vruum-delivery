        ...
        <div class="container mt-5">
            ...
            margin-top: 130px;">
                <div class="card-header text-white" style="text-align: center;">
                    <h6 class="m-0">Pedidos Cadastrados</h6>
                </div>
                <div class="card-body">
                    <table id="table_pedidos" class="table table-hover" style="color: white;">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td scope="row">{{$entrega->idCliente}}</td>
                                <td scope="row">{{$entrega->rua}}, {{$entrega->numero}} - {{$entrega->bairro}}</td>
                                <td scope="row">{{$entrega->ruaEntrega}}, {{$entrega->numeroEntrega}} - {{$entrega->bairroEntrega}}</td>
                                <td scope="row">{{$entrega->idMotoqueiro}}</td>
                                <td scope="row">{{$entrega->status}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
